                    ...
                    @if ($data['flag'] == true)
                        <div class="">
                            ...
                            <div style="font-size: 17px; line-height: 140%; word-wrap: break-word;">
                                <div>Greetings From {{ config('app.app_name') }}!<br>Your Account has been created
                                    successfully <br>the
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table_style"><strong>{{ $data['order']->cost_per_page ?? '-' }} </strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="table_style"><strong>{{ $data['order']->style ?? '-' }}  </strong></td>
                                </tr>
                                <tr>
