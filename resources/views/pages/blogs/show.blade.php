...
<style>
 ...
 h3 {
    ...
    @if (!empty($blog))
        ...
        <img src="{{ url(config('app.storage_path') . $blog->image_path) }}" alt="{{ $blog->title }}" class="my-10 mx-auto border-8 border-gray-100 hover:opacity-70 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-10 cursor-pointer max-h-[30rem]">
