    ...
    <section>
        ...
        <div class="lg:mx-12 pb-4">
            <div class="container mx-auto px-4 pb-4">
                @if (session('userData'))
                    <div class="md:w-1/2 my-4 mx-auto  border-t-4 bg-white border-primary-one-dark rounded-b text-primary-one-dark px-4 py-3 shadow-md"
                        role="alert">
                        <div class="flex">
                            <div class="py-1">
                ...
                <div class=" px-4 space-y-4">
                    <div class="border rounded-2xl bg-white max-w-sm mx-auto" style="box-shadow: 0 0 5px 2px rgb(0 0 0 / 16%);">
                        ...
                        <div class="w-full px-6 py-4 text-center">
                            <a href="{{ url('http://127.0.0.1:8002/payment?reference=' . $invoice->ref_no . '&gateway=stripe&source='.config('app.slug')) }}"
                                class="btn-primary block order">
